...
public class Sensor extends SimEntity{
	...
	public Sensor(String name, String tupleType, int userId, String appId, Distribution transmitDistribution, int sensorPriority) {
		super(name);
		this.setAppId(appId);
		this.setTransmitDistribution(transmitDistribution);
		this.priority =  sensorPriority;
		setTupleType(tupleType);
		setSensorName(tupleType);
		setUserId(userId);
	}
