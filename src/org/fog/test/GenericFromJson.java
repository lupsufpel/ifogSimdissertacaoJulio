...
public class GenericFromJson {
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 */
			PhysicalTopology physicalTopology = JsonToTopology.getPhysicalTopology(broker.getId(), appId, "topologies/genericTopology");
...
private static Application createApplication(String appId, int userId){
	...
	//	final AppLoop loop2 = new AppLoop(new ArrayList<String>(){{add("client");add("EGG");add("DISPLAY");}});
